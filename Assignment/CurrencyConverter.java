...
public class CurrencyConverter {
	...
	public static void main(String[] args) {
		...
		System.out.println("Choose the currency in which you are entering the price:");
	...
	public static void Ruppe_to_other(double amt) {
		...
		System.out.println("1 Ruppe = " + 0.012 + " Yen");
		System.out.println();
		System.out.println(amt + " Ruppe = " + (amt * 1.63) + "Yen");
		System.out.println();
	}
	...
	public static void Dollar_to_other(double amt) {
		...
		System.out.println("1 Dollar = " + 133.35 + " Yen");
		System.out.println();
		System.out.println(amt + " Dollar = " + (amt * 133.35) + "Yen");
		System.out.println();
	}
	...
	public static void Euro_to_other(double amt) {
		...
		System.out.println("1 Euro = " + 147.25 + " Yen");
		System.out.println();

		System.out.println(amt + " Euro = " + (amt * 147.25) + " Yen");
	}
	
	public static void Yen_to_other(double amt) {
		System.out.println("1 Yen = " + 0.65 + " Ruppe");
		System.out.println();
